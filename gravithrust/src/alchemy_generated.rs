...
Kind::Generator => &[QuantityKind::Heat,QuantityKind::Water,QuantityKind::Energy],
...
Kind::Flower => &[QuantityKind::Water,QuantityKind::Nectar],
...
Kind::SunCore => &[],
Kind::IceMelter => &[QuantityKind::Water,QuantityKind::Energy,QuantityKind::Ice],
...
Kind::IronFurnace => &[QuantityKind::Coal,QuantityKind::IronOre,QuantityKind::Iron,QuantityKind::IronGangue,QuantityKind::Heat],
