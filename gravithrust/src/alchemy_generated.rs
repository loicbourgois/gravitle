...
Kind::IronFurnace => &[QuantityKind::Iron,QuantityKind::Heat,QuantityKind::IronGangue,QuantityKind::IronOre,QuantityKind::Coal],
...
Kind::PlasmaCargo => &[],
Kind::Generator => &[QuantityKind::Energy,QuantityKind::Heat,QuantityKind::Water],
