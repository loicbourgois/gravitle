...
Kind::Static => &[],
Kind::Generator => &[QuantityKind::Water,QuantityKind::Heat,QuantityKind::Energy],
...
Kind::IceMelter => &[QuantityKind::Ice,QuantityKind::Water,QuantityKind::Energy],
...
Kind::IronFurnace => &[QuantityKind::Coal,QuantityKind::IronOre,QuantityKind::IronGangue,QuantityKind::Iron,QuantityKind::Heat],
