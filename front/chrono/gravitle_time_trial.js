...
export class World {
	...
	set victory_duration(arg0) {
		wasm.__wbg_set_world_victory_duration(
			this.__wbg_ptr,
	...
	set victory_end(arg0) {
		wasm.__wbg_set_world_victory_end(
			this.__wbg_ptr,
			isLikeNone(arg0) ? 0x100000001 : arg0 >>> 0,
		);
	}
	 ...
	 */
	set move_start(arg0) {
		wasm.__wbg_set_world_move_start(
			this.__wbg_ptr,
			isLikeNone(arg0) ? 0x100000001 : arg0 >>> 0,
		);
	}
...
const WrapAroundResultFinalization =
	typeof FinalizationRegistry === "undefined"
		? { register: () => {}, unregister: () => {} }
		: new FinalizationRegistry((ptr) =>
				wasm.__wbg_wraparoundresult_free(ptr >>> 0, 1),
			);
...
if (Symbol.dispose)
	WrapAroundResult.prototype[Symbol.dispose] = WrapAroundResult.prototype.free;
