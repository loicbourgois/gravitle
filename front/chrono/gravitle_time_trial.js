...
export class World {
    ...
    set victory_fuel_used(arg0) {
        wasm.__wbg_set_world_victory_fuel_used(this.__wbg_ptr, isLikeNone(arg0) ? 0x100000001 : (arg0) >>> 0);
    }
    /**
     * @returns {number | undefined}
     */
    ...
    add_cell(x, y, diameter, kind, user_kind) {
        const ret = wasm.world_add_cell(this.__wbg_ptr, x, y, diameter, kind, user_kind);
        return ret >>> 0;
    }
    /**
     * @returns {string}
    ...
    setup(seed, asteroid_count, star_count, user_kind) {
        ...
        wasm.world_setup(this.__wbg_ptr, ptr0, len0, asteroid_count, star_count, user_kind);
    }
    /**
     * @returns {World}
     */
